...
public class AppConstants {
	...
	public static final String MESSAGE_1C_ALL = "Commercial tools give an option of testing non-browser based applications unlike opensource tools.Using them for a desktop/mainframe-based application/web/mobile-based application is a good path to take for test automation. But using record and play along with descriptive programming would cause complications in maintaining the test bed. Our suggestion would be to use the advantage of having a commercial tool to the fullest by going towards scripting. Going this route will not only make your test bed more efficient, but also give more time and money towards increasing your test coverage.";
	//D-Type Messages
	...
	public static final String MESSAGE_1D = "Commercial tools give an option of testing non-browser based applications unlike opensource tools.Using them for a desktop/mainframe-based application/web/mobile-based application is a good path to take for test automation. But using record and play would cause complications in maintaining the test bed. Our suggestion would be to use the advantage of having a commercial tool to the fullest by going towards scripting. Going this route will not only make your test bed more efficient, but also give more time and money towards increasing your test coverage.";
