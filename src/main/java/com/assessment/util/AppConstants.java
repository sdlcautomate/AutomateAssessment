...
public class AppConstants {
	...
	public static final String MESSAGE_5A = "Test coverage helps you to identify how thoroughly testing has been performed. From the survey completed by your organization we can see that you are using industry standard tools and have descriptive programming script. We as a team from SDLC Partners, can help you in increasing your test coverage which helps in delivering a more defect free product.";
	public static final String MESSAGE_5A_APPIUM= "Test coverage helps you to identify how thoroughly testing has been performed. From the survey completed by your organization we can see that you are using industry standard tools and have descriptive programming script. We as a team from SDLC Partners, can help you in increasing your test coverage and recommend using tools like APPIUM which helps in delivering a more defect free product.";
	...
	public static final String MESSAGE_1C_BOTH = "Commercial tools give an option of testing non-browser based applications unlike opensource tools. Using them for a desktop and mainframe-based application is a good path to take for test automation. But using record and play along with descriptve programming would cause complications in maintaining the test bed. Our suggestion would be to use the advantage of having a commercial tool to the fullest by going towards scripting. Going this route will not only make your test bed more efficient, but also give more time and money towards increasing your test coverage.";
	public static final String MESSAGE_1C_ALL = "Commercial tools give an option of testing non-browser based applications unlike opensource tools. Using them for a desktop and mainframe-based application/Web Application - Mobile is a good path to take for test automation. But using record and play along with descriptve programming would cause complications in maintaining the test bed. Our suggestion would be to use the advantage of having a commercial tool to the fullest by going towards scripting. Going this route will not only make your test bed more efficient, but also give more time and money towards increasing your test coverage.";
	//D-Type Messages
	public static final String MESSAGE_1D_BOTH="Commercial tools give an option of testing non-browser based applications unlike opensource tools. Using them for a Web and Mobile based application is a good path to take for test automation. But using record and play along with descriptve programming would cause complications in maintaining the test bed. Our suggestion would be to use the advantage of having a commercial tool to the fullest by going towards scripting. Going this route will not only make your test bed more efficient,but also give more time and money towards increasing your test coverage. We as a team from SDLC Partners, can help you in decreasing your test coverage using scripting framework.";
