...
public class AppConstants {
	...
	public static final String MESSAGE_2A_REC_PLAY_ALL = "Selenium is a portable open source tool, that provides a means to test web applications either by record and playback or scripting. As this tool was mainly designed to automate web application, using it for a desktop/mainframe/web/mobile based application would need third party software in addition. There would be risks to continuing in this path. Making updates to existing scripts would get more complicated. Our suggestion would be to consider using a commercial tool. Going this route will not only make scripting more efficient for such applications, but also give more time and money towards increasing your test coverage.Also, we can help explore other commercial tools more proficient in automating desktop and mainframe applications as selenium works best with web applications.";
	public static final String MESSAGE_3A = "Selenium is a portable open source tool, that provides a means to test web applications either by record and playback or scripting. As this tool was mainly designed to automate web application, using it for a desktop/mainframe-based application would need third party software in addition. There would be risks to continuing in this path. Making updates to existing scripts would get more complicated. Our suggestion would be to consider using a commercial tool. Going this route will make scripting and maintaining your test automation more efficient for such applications.";
	...
	public static final String MESSAGE_1C_ALL = "Commercial tools give an option of testing non-browser based applications unlike opensource tools.Using them for a desktop/mainframe/web/mobile based application is a good path to take for test automation. But using record and play along with descriptive programming would cause complications in maintaining the test bed. Our suggestion would be to use the advantage of having a commercial tool to the fullest by going towards scripting. Going this route will not only make your test bed more efficient, but also give more time and money towards increasing your test coverage.";
	//D-Type Messages
	public static final String MESSAGE_1D_BOTH="Commercial tools give an option of testing non-browser based applications unlike opensource tools.Using them for a Web/Mobile based application is a good path to take for test automation.But using record and play along with descriptive programming would cause complications in maintaining the test bed. Our suggestion would be to use the advantage of having a commercial tool to the fullest by going towards scripting. Going this route will not only make your test bed more efficient, but also give more time and money towards increasing your test coverage.";
	public static final String MESSAGE_1D = "Commercial tools give an option of testing non-browser based applications unlike opensource tools.Using them for a desktop/mainframe/web/mobile based application is a good path to take for test automation. But using record and play would cause complications in maintaining the test bed. Our suggestion would be to use the advantage of having a commercial tool to the fullest by going towards scripting. Going this route will not only make your test bed more efficient, but also give more time and money towards increasing your test coverage.";
	public static final String MESSAGE_1D_REC_WEBMOB = "Commercial tools give an option of testing non-browser based applications unlike opensource tools. Using them for a Web/Mobile based application is a good path to take for test automation. But using record and play would cause complications in maintaining the test bed. Our suggestion would be to use the advantage of having a commercial tool to the fullest by going towards scripting. Going this route will not only make your test bed more efficient,but also give more time and money towards increasing your test coverage.";
