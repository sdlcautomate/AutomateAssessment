...
public class AppConstants {
	...
	public static final String MESSAGE_6B = "Selenium is a portable open source tool, that provides a means to test web applications either by record and playback or scripting. As this tool was mainly designed to automate web application, using it for a desktop and mainframe based application would need third party software in addition. There would be risks to continuing in this path. Making updates to existing scripts would get more complicated. Our suggestion would be to consider using a commercial tool. Going this route will not only make scripting more efficient for such applications, but also give more time and money towards increasing your test coverage. We as a team from SDLC Partners, can help you in increasing your test coverage using scripting framework and commercial tool. ";
	...
	public static final String QUESTION_3b = "3) Do you prefer Open Source or Commercial tools?";
